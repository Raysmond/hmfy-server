...
import { ShipPlanComponent } from 'app/entities/ship-plan/ship-plan.component';
...
describe('Component Tests', () => {
  describe('ShipPlan Management Component', () => {
    let comp: ShipPlanComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(ShipPlanComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.shipPlans[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
