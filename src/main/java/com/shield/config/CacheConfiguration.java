...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.shield.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.shield.repository.UserRepository.USERS_BY_EMAIL_CACHE);
            ...
            createCache(cm, com.shield.domain.GateRecord.class.getName());
            createCache(cm, com.shield.domain.Plan.class.getName());
