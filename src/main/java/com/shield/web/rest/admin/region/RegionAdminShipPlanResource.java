...
public class RegionAdminShipPlanResource {

    private final Logger log = LoggerFactory.getLogger(RegionAdminShipPlanResource.class);
    ...
    public RegionAdminShipPlanResource(ShipPlanService shipPlanService, ShipPlanQueryService shipPlanQueryService) {
